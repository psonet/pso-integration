//! S037 — admin `revoke_attester(addr)` against a never-registered
...
//! never bound — leaving a live Attester assumed dead.
...
impl Scenario for S037 {
    ...
    fn description(&self) -> &'static str {
        "admin.revoke_attester against a never-registered address reverts NotRegistered(addr)"
    }
